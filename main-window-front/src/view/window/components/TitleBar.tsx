...
interface TitleBarProps {
  appTitle?: string;        // необязательный
  searchEnabled?: boolean;   // обратим внимание на опечатку: Enabled
}

const TitleBar: React.FC<TitleBarProps> = ({appTitle = "AS Tools", searchEnabled = true}) => {
